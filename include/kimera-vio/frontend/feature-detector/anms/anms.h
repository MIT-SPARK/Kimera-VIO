...
inline vector<cv::KeyPoint> TopN(vector<cv::KeyPoint> keyPoints, int numRetPoints) {
...
vector<cv::KeyPoint> GridFAST(cv::Mat Image,
                              int numRetPoints,
                              int gridRows,
                              int gridCols) {
  vector<cv::KeyPoint> kp;
...
inline vector<cv::KeyPoint> BrownANMS(vector<cv::KeyPoint> keyPoints,
                               int numRetPoints) {
...
inline vector<cv::KeyPoint> Sdc(vector<cv::KeyPoint> keyPoints,
                         int numRetPoints,
                         float tolerance,
                         int cols,
                         int rows) {
...
template <typename T>
inline void generatePointCloud(PointCloud<T>& point, vector<cv::KeyPoint> keyPoints) {
...
inline vector<cv::KeyPoint> KdTree(vector<cv::KeyPoint> keyPoints,
                            int numRetPoints,
                            float tolerance,
                            int cols,
                            int rows) {
...
inline vector<cv::KeyPoint> RangeTree(vector<cv::KeyPoint> keyPoints,
                               int numRetPoints,
                               float tolerance,
                               int cols,
                               int rows) {
...
inline vector<cv::KeyPoint> Ssc(vector<cv::KeyPoint> keyPoints,
                         int numRetPoints,
                         float tolerance,
                         int cols,
                         int rows) {
...
inline void VisualizeAll(cv::Mat Image,
