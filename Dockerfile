...
ADD https://api.github.com/repos/ToniRV/spark_vio_evaluation/git/refs/heads/feature/data_source_module version.json
RUN git clone https://github.com/ToniRV/spark_vio_evaluation.git
RUN cd spark_vio_evaluation && git checkout -b feature/data_source_module && pip install .
