pipeline {
  ...
  stages {
    stage('Build') {
      steps {
          slackSend color: 'good', message: "Started Build <${env.BUILD_URL}|#${env.BUILD_NUMBER}> - Branch <${env.GIT_URL}/tree/${env.GIT_BRANCH}|${env.GIT_BRANCH}> (${env.GIT_COMMIT:1}) (author: ${env.GIT_AUTHOR_NAME})."
