...
#include "kimera-vio/datasource/PRC_parser.h"
...
bool PRC_PARSER::spin_stereo(Mat, Mat, imu) {
  vio_callback_(
      StereoImuSyncPacket(StereoFrame(k,
                                      timestamp_frame_k,
...
void ETHDatasetParser::print() const {
  ...
  if (FLAGS_minloglevel < 1) camL_Pose_camR_.print("camL_Pose_calR \n");
