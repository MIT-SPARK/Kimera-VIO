...
VisionFrontEnd::VisionFrontEnd(const ImuParams& imu_params,
...
VisionFrontEnd::~VisionFrontEnd() {
  LOG(INFO) << "VisionFrontEnd destructor called.";
}

FrontendOutputPacketBase::UniquePtr VisionFrontEnd::spinOnce(
...
void VisionFrontEnd::outlierRejectionMono(
...
void VisionFrontEnd::printTrackingStatus(const TrackingStatus& status,
