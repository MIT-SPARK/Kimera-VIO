...
/**
 * @file   testGeneralParallelPlaneRegularBasicFactor.cpp
 * @brief  test GeneralParallelPlaneRegularBasicFactor
...
/**
  ...
  *
/* ************************************************************************* */
TEST(testGeneralParallelPlaneRegularBasicFactor, PlaneOptimization) {
