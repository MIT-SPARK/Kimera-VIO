...
# Macro:
#
# gtsamAddExamplesGlob(globPatterns excludedFiles linkLibraries otherCppFiles)
# 
...
#
# Usage example:
#   gtsamAddExamplesGlob("*.cpp" "BrokenExample.cpp" "gtsam;GeographicLib" "dependent.cpp")
#
# Arguments:
...
#   dependent.cpp: The list of other cpp files to include.
macro(gtsamAddExamplesGlob globPatterns excludedFiles linkLibraries otherCppFiles)
  string(REPLACE ";" " " otherSrcFiles "${otherCppFiles}")
  message(STATUS "Zhengdong3: otherCppFiles = ${otherSrcFiles}")
	gtsamAddExesGlob_impl("${globPatterns}" "${excludedFiles}" "${linkLibraries}" "${otherCppFiles}" "examples" ${GTSAM_BUILD_EXAMPLES_ALWAYS})
endmacro()
...
macro(gtsamAddExesGlob_impl globPatterns excludedFiles linkLibraries otherCppFiles groupName buildWithAll)
    message(STATUS "Zhengdong: linkLibraries = ${linkLibraries}")
    # Get all script files
    file(GLOB script_files ${globPatterns})
	...
	foreach(script_src IN ITEMS ${script_srcs})
		...
		# Add executable
    message(STATUS "Zhengdong3: otherCppFiles = ${otherCppFiles}")
		add_executable(${script_name} ${script_src} ${otherCppFiles} ${script_headers})
		target_link_libraries(${script_name} ${linkLibraries})

    message(STATUS "Zhengdong: add_executable(${script_name} ${script_src} ${otherCppFiles} ${script_headers})")
    message(STATUS "Zhengdong: target_link_libraries(${script_name} ${linkLibraries}")
